<div class="footer-container">
          <div class="top-foot">
            ...
            <div class="help-desktop">
              <h4 class="m-0 need-help mb-10">Do you need help?</h4>
          ...
          <div class="bottom-foot">
            <div class="div1">
              ...
              <div class="copy-desktop">© 2025 — Copyright</div>
            ...
            <ul class="div2 m-0">
              <h4 class="nav m-0 mb-4">Navigation </h4>
              <li>
                <a href="">Home</a>
              </li>
              <li>
            ...
            <div class="div4">
              ...
              <div class="input-div">
                <p>your@email.ru</p>
                <img src="<?php echo get_template_directory_uri() ?>/image/vector.svg" alt="">
              </div>
            </div>
            <div class="logo-container-mobile mb-20">
              <div class="logo1">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16 8C16 3.6 12.4 0 8 0C3.6 0 0 3.6 0 8C0 12 2.9 15.3 6.7 15.9V10.3H4.7V8H6.7V6.2C6.7 4.2 7.9 3.1 9.7 3.1C10.6 3.1 11.5 3.3 11.5 3.3V5.3H10.5C9.5 5.3 9.2 5.9 9.2 6.5V8H11.4L11 10.3H9.1V16C13.1 15.4 16 12 16 8Z" fill="white"/>
                </svg>
            ...
            <div class="copy-mobile">© 2025 — Copyright</div>
          </div>
        </div>
...
window.addEventListener("message", function(event) {
    ...
    var data = event.data;
    if (data.setting === "header_text") {
        document.getElementById("site-header-text").innerText = data.value;
    }
    if (data.setting === "banner_text") {
        document.getElementById("site-banner-text").innerText = data.value;
    }
    if (data.setting === "logo_url") {
        document.getElementById("site-logo").src = data.value;
    }
    if (data.setting === "banner_image") {
        document.getElementById("site-banner-image").src = data.value;
    }
});
</script>
    ...
    <script>
      $(document).ready(function () {
        ...
        $(document).click(function (event) {
          if (!$(event.target).closest(".menu, .burgerMenu").length) {
            $(".menu").removeClass("active");
          }
        });
      });
